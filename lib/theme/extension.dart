...
extension PaddingHelper on Widget {
  ...
  Padding ps({double x = 0.0, double y = 0.0}) => Padding(
        padding: EdgeInsets.symmetric(horizontal: x, vertical: y),
        child: this,
      );

  /// Horizontal Padding 4,8, and 16
  Padding get hP4 =>
...
extension OpacityHelper on Widget {
  Opacity op(double opacity) => Opacity(
        opacity: opacity,
        child: this,
      );
}
